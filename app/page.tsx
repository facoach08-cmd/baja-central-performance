...
export default function Home() {
  ...
  function operationalSummary(client: Client) {
    ...
    return { sourceCount: rows.length, lateSources, alerts, level, accesses7d: accessCount(client.id, 7) };
  }
